...
public class editJobTitle {
	public static void main(String[] args) {
		...
		driver.get("https://opensource-demo.orangehrmlive.com/index.php/admin/saveJobTitle?jobTitleId=36");
		...
		driver.findElement(By.id("jobTitle_jobTitle")).sendKeys("Test");
		
		//edit job description
		driver.findElement(By.id("jobTitle_jobDescription")).clear();
		driver.findElement(By.id("jobTitle_jobDescription")).sendKeys("Test");
		
		
		//Memilih radio button yang ke 3 (replace)
		driver.findElement(By.xpath("//*[@id = 'jobTitle_jobSpecUpdate_3']")).click();
		
		//edit file job spesifikasi
		WebElement file = driver.findElement(By.xpath("//*[@id = 'jobTitle_jobSpec']"));
	    file.clear();
	    file.sendKeys("F:\\test1.jpg");
	    
	    //edit job note
		driver.findElement(By.id("jobTitle_note")).clear();
		driver.findElement(By.id("jobTitle_note")).sendKeys("testing!");
